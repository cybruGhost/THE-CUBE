...
- **PC EXE** – For Windows, Kali, Ubuntu, Parrot, and any Linux distro (Mac users can use the browser, e.g., Brave browser)
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/a79be0e7-1b24-466a-94ce-e6e3a39e7f54" alt="Screenshot 3" width="800"/>
</div>
...
At TheCube, users choose their content, browse curated shows, and stream instantly — all inside a sleek, intuitive UI inspired by platforms you already love.

---

## 🔐 Security

**Note:** THECUB4.VERCEL.APP / THECUB4 doesn't require an account. You may sign in if you want to sync your data and backup it.

We only store watch history if signed in so that we can sync to your other devices, but collect no personal logs. Just pure streaming. If not signed in, all data is stored on your device's local storage.
...
The future includes AI personalization and offline access.
...
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=cybruGhost&theme=react-dark" alt="Contribution activity heatmap" width="90%"/>
</p>
